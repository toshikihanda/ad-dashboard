 ...
 * 優先順:
 * 1) Meta入稿名のカッコ直後（例: 【60_109】286, 【60_109】286b）
 * 2) 3桁 + _ + 英字1〜2文字（例: 219_g, 219_ab）
 * 3) bt + 数字（例: bt005）
 * 4) 最後の _ に続く3桁 + 任意の英字（例: 60_106_288, 60_106_288b）
 * 5) 3桁 + 英字1〜2文字 直結（例: 219g, 219ab）※ 219 と 219g は別クリエイティブ
 * 6) 3桁の数字のみ（例: 219）※ 直後に英数字がある場合は別パターンへ委ねる
